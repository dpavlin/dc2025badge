...
/**
  ******************************************************************************
  * @file  : custom.c
  * @brief : Source file for the BADGEBSP Common driver
  ******************************************************************************
  * @attention
  *
 ...
 * @{
 */
typedef void (* BADGEBSP_EXTI_LineCallback) (void);
typedef void (* BADGEBSP_BUTTON_GPIO_Init) (void);
...
extern EXTI_HandleTypeDef hpb_exti[BUTTONn]; // = {{.Line = EXTI_LINE_10}};
extern USART_TypeDef* COM_USART[COMn]; // = {COM1_UART};
...
#endif
/**
 * @brief  This method returns the STM32L0xx NUCLEO BADGEBSP Driver revision
 * @retval version: 0xXYZR (8bits for each decimal, R for RC)
 */
int32_t BADGEBSP_GetVersion(void)
{
  return (int32_t)__CUSTOM_BADGEBSP_VERSION;
}
...
/**
  ...
  * @retval BADGEBSP status
  */
int32_t BADGEBSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  int32_t ret = BSP_ERROR_NONE;

  static const BADGEBSP_EXTI_LineCallback ButtonCallback[BUTTONn] ={BUTTON_USER_EXTI_Callback};
  static const uint32_t  BADGEBSP_BUTTON_PRIO [BUTTONn] ={BADGEBSP_BUTTON_USER_IT_PRIORITY};
  static const uint32_t BUTTON_EXTI_LINE[BUTTONn] ={USER_BUTTON_EXTI_LINE};
  static const BADGEBSP_BUTTON_GPIO_Init ButtonGpioInit[BUTTONn] = {BUTTON_USER_GPIO_Init};
  ...
  if (ButtonMode == BUTTON_MODE_EXTI)
  {
	...
	else
    {
      ...
      HAL_NVIC_SetPriority((BUTTON_IRQn[Button]), BADGEBSP_BUTTON_PRIO[Button], 0x00);
...
/**
 * @brief  BADGEBSP Push Button callback
 * @param  Button Specifies the pin connected EXTI line
 * @retval None.
 */
__weak void BADGEBSP_PB_Callback(Button_TypeDef Button)
{
...
static void BUTTON_USER_EXTI_Callback(void)
{
  BADGEBSP_PB_Callback(BUTTON_USER);
}
...
static void BUTTON_USER_GPIO_Init(void) {
  ...
  GPIO_InitStruct.Pin = BUS_BADGEBSP_BUTTON_GPIO_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BUS_BADGEBSP_BUTTON_GPIO_PORT, &GPIO_InitStruct);
...
int32_t BADGEBSP_COM_Init(COM_TypeDef COM)
{
  ...
  else
  {
    ...
    {
      if(BADGEBSP_COM_RegisterDefaultMspCallbacks(COM) != BADGEBSP_ERROR_NONE)
      {
        return BADGEBSP_ERROR_MSP_FAILURE;
      }
    }
#endif
...
{
  int32_t ret = BADGEBSP_ERROR_NONE;

  if(COM >= COMn)
  {
    ret = BADGEBSP_ERROR_WRONG_PARAM;
  }
  else
  {
    ...
    {
      ret = BADGEBSP_ERROR_PERIPH_FAILURE;
    }
